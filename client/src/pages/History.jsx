  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      <motion.header
        ...
        className="mb-10 rounded-2xl bg-blue-900 border border-white/10 px-8 py-6 flex justify-between md:items-center gap-4 flex-wrap"
      >
        ...
        <div className='flex items-center gap-4'>
          ...
          <button
            className='px-4 py-3 rounded-full text-sm font-medium bg-white/10 border border-white/20 text-white flex items-center gap-2 hover:bg-white/20 transition'
        ...
        <AnimatePresence>
          {isSidebarOpen && (
            <motion.div
              ...
              className='fixed lg:static top-0 left-0 z-50 lg:z-auto w-72 lg:w-auto h-full lg:h-[75vh] lg:rounded-3xl lg:col-span-1 bg-black/90 lg:bg-black/80 backdrop-blur-xl border border-white/10 p-5 overflow-y-auto'
            >
